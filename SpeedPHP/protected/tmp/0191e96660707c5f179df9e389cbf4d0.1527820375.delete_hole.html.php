			...
			<div class="col-xs-6 col-sm-10">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">过时漏洞信息</h3>
					</div>
					<div class="panel-body">
						<form method="post" action="<?php echo url(array('c'=>'manage', 'a'=>'hole_del', ));?>">
						...
						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="btn-group" role="group" aria-label="First group">
								<a href="<?php echo url(array('c'=>'manage', 'a'=>'hole', ));?>">
								 	<button type="button" class="btn btn-default">           
						           		<span aria-hidden="true">首页
						           		</span>
						       		</button>
						       	</a>
								<a href="<?php echo url(array('c'=>'manage', 'a'=>'hole', 'p'=>$pager['prev_page'], ));?>">
									<button type="button" class="btn btn-default">
						        ...
						        <?php endif; ?>
						            <a href="<?php echo url(array('c'=>'manage', 'a'=>'hole', 'p'=>$p, ));?>">
						            	<button type="button" class="btn btn-default"><?php echo htmlspecialchars($p, ENT_QUOTES, "UTF-8"); ?>
						            	</button>
						            </a>
						        <?php endforeach; }?>
						        <a href="<?php echo url(array('c'=>'manage', 'a'=>'hole', 'p'=>$pager['next_page'], ));?>">
						        	<button type="button" class="btn btn-default">
