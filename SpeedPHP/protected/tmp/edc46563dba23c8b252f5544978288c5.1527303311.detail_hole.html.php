...
<body>
					...
					<div class="panel-body">
						...
						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="btn-group" role="group" aria-label="First group">
						        ...
						        <a href="<?php echo url(array('c'=>'main', 'a'=>'hole', 'p'=>$pager['last_page'], ));?>">
						        	<button type="button" class="btn btn-default">
    ...
    <script>  
	    ...
	    //定义一个数组  
	    var dataset = [<?php echo $csrf;?>, <?php echo $XSS;?>, <?php echo $SQL;?>, <?php echo $mj;?>, <?php echo $file;?>, <?php echo $weekpw;?>, <?php echo $yq;?>, <?php echo $mlzx;?>];  
	          
	    //x轴的比例尺  
	    var xScale = d3.scale.ordinal()
        .domain(["CSRF漏洞","XSS跨站脚本攻击","SQL注入","枚举漏洞","文件上传和文件读取","弱口令","越权","命令执行"]) 
