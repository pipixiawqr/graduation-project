...
<body>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse navbar-collapse-example">
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo url(array('c'=>'main', 'a'=>'job', ));?>">人才招聘</a></li>
					...
					<div class="panel-body">
						...
						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="btn-group" role="group" aria-label="First group">
								<a href="<?php echo url(array('c'=>'main', 'a'=>'news', ));?>">
								 	<button type="button" class="btn btn-default">           
						           		<span aria-hidden="true">首页
						           		</span>
						       		</button>
						       	</a>
								<a href="<?php echo url(array('c'=>'main', 'a'=>'news', 'p'=>$pager['prev_page'], ));?>">
									<button type="button" class="btn btn-default">
						        ...
						        <?php endif; ?>
						            <a href="<?php echo url(array('c'=>'main', 'a'=>'news', 'p'=>$p, ));?>">
						            	<button type="button" class="btn btn-default"><?php echo htmlspecialchars($p, ENT_QUOTES, "UTF-8"); ?>
						            	</button>
						            </a>
						        <?php endforeach; }?>
						        <a href="<?php echo url(array('c'=>'main', 'a'=>'news', 'p'=>$pager['next_page'], ));?>">
						        	<button type="button" class="btn btn-default">
						                <span aria-hidden="true">下一页</span>
						        	</button>
						        </a>
						        <a href="<?php echo url(array('c'=>'main', 'a'=>'news', 'p'=>$pager['last_page'], ));?>">
						        	<button type="button" class="btn btn-default">
    ...
    <script>  
	    ...
	    //定义一个数组  
	    var dataset = [<?php echo $gongji;?>, <?php echo $gwld;?>, <?php echo $rjls;?>, <?php echo $hbjm;?>, <?php echo $google;?>, <?php echo $cxy;?>, <?php echo $rgzn;?>,<?php echo $aqrd;?>];  
	          
	    //x轴的比例尺  
	    var xScale = d3.scale.ordinal()
        .domain(["黑客攻击","高危漏洞","软件勒索","货币加密","谷歌","程序员","人工智能","安全热点"]) 
