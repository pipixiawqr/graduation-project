					...
					<div class="panel-body">
						...
						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="btn-group" role="group" aria-label="First group">
								<a href="<?php echo url(array('c'=>'main', 'a'=>'tech', ));?>">
								 	<button type="button" class="btn btn-default">           
						           		<span aria-hidden="true">首页
						           		</span>
						       		</button>
						       	</a>
								<a href="<?php echo url(array('c'=>'main', 'a'=>'tech', 'p'=>$pager['prev_page'], ));?>">
									<button type="button" class="btn btn-default">
						        ...
						        <?php endif; ?>
						            <a href="<?php echo url(array('c'=>'main', 'a'=>'tech', 'p'=>$p, ));?>">
						            	<button type="button" class="btn btn-default"><?php echo htmlspecialchars($p, ENT_QUOTES, "UTF-8"); ?>
						            	</button>
						            </a>
						        <?php endforeach; }?>
						        <a href="<?php echo url(array('c'=>'main', 'a'=>'tech', 'p'=>$pager['next_page'], ));?>">
						        	<button type="button" class="btn btn-default">
						                <span aria-hidden="true">下一页</span>
						        	</button>
						        </a>
						        <a href="<?php echo url(array('c'=>'main', 'a'=>'tech', 'p'=>$pager['last_page'], ));?>">
						        	<button type="button" class="btn btn-default">
