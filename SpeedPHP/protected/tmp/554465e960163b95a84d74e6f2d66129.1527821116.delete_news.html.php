			...
			<div class="col-xs-6 col-sm-10">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse navbar-collapse-example">
							<ul class="nav navbar-nav">
								...
								<li><a href="<?php echo url(array('c'=>'manage', 'a'=>'job', ));?>">招聘信息</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">过时安全资讯</h3>
					</div>
					<div class="panel-body">
						<form method="post" action="<?php echo url(array('c'=>'manage', 'a'=>'news_del', ));?>">
						...
						<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
							...
							<div class="btn-group" role="group" aria-label="First group">
								<a href="<?php echo url(array('c'=>'manage', 'a'=>'news', ));?>">
								 	<button type="button" class="btn btn-default">           
						           		<span aria-hidden="true">首页
						           		</span>
						       		</button>
						       	</a>
								<a href="<?php echo url(array('c'=>'manage', 'a'=>'news', 'p'=>$pager['prev_page'], ));?>">
									<button type="button" class="btn btn-default">
						        ...
						        <?php endif; ?>
						            <a href="<?php echo url(array('c'=>'manage', 'a'=>'news', 'p'=>$p, ));?>">
						            	<button type="button" class="btn btn-default"><?php echo htmlspecialchars($p, ENT_QUOTES, "UTF-8"); ?>
						            	</button>
						            </a>
						        <?php endforeach; }?>
						        <a href="<?php echo url(array('c'=>'manage', 'a'=>'news', 'p'=>$pager['next_page'], ));?>">
						        	<button type="button" class="btn btn-default">
